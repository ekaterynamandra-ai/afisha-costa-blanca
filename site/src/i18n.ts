...
export const ui = {
  ru: {
    ...
    'home.hero.lead': 'Как обустроиться на Коста-Бланке в первый год: жильё, документы, врач, банк, налоги. Плюс места, ради которых сюда стоило ехать, и способ зарабатывать онлайн.',
    'home.cta.primary': 'С чего начать',
    'home.cta.telegram': 'Телеграм-канал',

    'home.sections.title': 'С чего начнём',
    'home.sections.sub': 'В том порядке, в котором это происходит на самом деле: сначала обустроиться и найти свой ритм, потом — зарабатывать.',
    ...
    'section.ai.lead': 'Как AI освобождает время: гиды, кейсы, инструменты. И наши продукты внизу, если хочется глубже.',
